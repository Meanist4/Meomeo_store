...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        scrollPopular.setBackground(new java.awt.Color(255, 255, 255));

        panelProductGrid.setBackground(new java.awt.Color(255, 255, 255));
        panelProductGrid.setLayout(new java.awt.GridLayout());
        scrollPopular.setViewportView(panelProductGrid);

        jPanel1.add(scrollPopular, java.awt.BorderLayout.CENTER);
